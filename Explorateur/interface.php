...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <aside>
      ...
      <div class="vertical">
          <ul>
            <a href="#" id="create"><img src="img/creer.png" height='30' width='30'>Créer dossiers / fichiers</a>
                <div class="create mm">
            ...
            <a href="#" id="copied"><img src="img/copier.png" height='30' width='30'>Copier dossiers / fichiers</a>
            <div class="copied mm">
              <!--Copier un fichier -->
       		   <form  method="POST">
       		       <input type="text" name="ACopier" placeholder="doc a copier">
       		       <input type="text" name="NouvNomFCopier" placeholder="nouveau nom">
            ...
            <a href="#" id="renamed"><img src="img/renommer.png" height='30' width='30'>Renommer dossiers / fichiers</a>
            <div class="renamed mm">
              <!--renommer un fichier-->
                <form  method="POST">
                    <input type="text" name="Arenommer" placeholder="fic a renommer">
                    <input type="text" name="newrenommer" placeholder="new name">
            ...
            <a href="#" id="deleted"><img src="img/supprimer.png" height='30' width='30'>Supprimer dossiers / fichiers</a>
            ...
            <a href="#" id="uploaded"><img src="img/upload.png" height='30' width='30'>Uploader dossiers / fichiers</a>
